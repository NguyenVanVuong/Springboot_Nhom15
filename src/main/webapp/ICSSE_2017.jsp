...
<link href="<c:url value="lib/CSS/show_img.css"/>" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="<c:url value="lib/javascript/jquery-1.7.2.min.js.taixuong"/>"></script>
    <script src="<c:url value="lib/javascript/Common.js.taixuong"/>" type="text/javascript"></script>
    <script src="<c:url value="lib/javascript/PagingContent.js.taixuong"/>" type="text/javascript"></script>
<link rel="shortcut icon" type="lib/image/png" href="<c:url value="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png"/>"></link>
<link href="<c:url value="lib/CSS/lightbox.css"/>" rel="stylesheet" type="text/css">
    <script src="<c:url value="lib/javascript/lightbox.min.js.taixuong"/>" type="text/javascript"></script>
    <link href="<c:url value="lib/CSS/search_Article.css"/>" rel="stylesheet">
...
<link href="<c:url value="lib/CSS/WebResource.axd"/>" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
<link href="<c:url value="lib/CSS/WebResource(1).axd"/>" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
<link href="<c:url value="lib/CSS/WebResource(2).axd"/>" type="text/css" rel="stylesheet" class="Telerik_stylesheet"></head>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDcyYzNhMmEwY2M0MRgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnUZKSf778xY5OZ5qNMSeBOIilvzvw==">
</div>
...
<script src="<c:url value="lib/CSS/WebResource(3).axd"/>" type="text/javascript"></script>


<script src="<c:url value="lib/CSS/Telerik.Web.UI.WebResource.axd"/>" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<script src="<c:url value="lib/javascript/jsdebug"/>" type="text/javascript"></script>
<script src="<c:url value="lib/javascript/jsdebug(1)"/>" type="text/javascript"></script>
<script src="<c:url value="lib/javascript/jsdebug(2)"/>" type="text/javascript"></script>
<script src="<c:url value="lib/javascript/jsdebug(3)"/>" type="text/javascript"></script>
<div>
...
<link href="<c:url value="lib/CSS/main.css"/>" rel="stylesheet">
<link href="<c:url value="lib/CSS/mainPortlets.css"/>" rel="stylesheet">
<script language="javascript" type="text/javascript">
    function SearchProcess(event) {
        if (event.keyCode == 13) {
            OnSearch(document.getElementById('txtSearchArticle').value);
...
<div class="anh_logo"><img alt="" src="<c:url value="lib/img/Banner Hoi nghi quoc te sua.jpg"/>" style="width: 800px; height: 188px;"><br>
</div>
<div class="name_ute">
</div>
</div>
...
<link href="<c:url value="lib/CSS/nivo-slider.css"/>" rel="stylesheet">
<link href="<c:url value="lib/CSS/default.css"/>" rel="stylesheet">

<script src="<c:url value="lib/javascript/jquery.nivo.slider.js.taixuong"/>"></script>
...
<div class="container" style="height:350px;">
    <div class="slider-wrapper theme-default">
        ...
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="<c:url value="lib/img/HNQT3.jpg"/>" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: block;">
                <img src="<c:url value="lib/img/HNQT2.jpg"/>" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="<c:url value="lib/img/HNQT1.jpg"/>" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <img class="nivo-main-image" src="<c:url value="lib/img/HNQT2.jpg"/>" style="display: inline; height: auto; width: 1000px;"><div class="nivo-caption"></div><div class="nivo-directionNav"><a class="nivo-prevNav">Prev</a><a class="nivo-nextNav">Next</a></div></div><div class="nivo-controlNav"><a class="nivo-control" rel="0">1</a><a class="nivo-control active" rel="1">2</a><a class="nivo-control" rel="2">3</a></div>
    </div>
</div>
<script>
...
<link href="<c:url value="lib/css/Menu.Green.css"/>" rel="stylesheet" type="text/css">
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        ...
        <a class="wobble-horizontal" href="http://icsse2017.hcmute.edu.vn/?TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2">
            <img src="<c:url value="lib/img/arrow_all_phong.png"/>"></a>
    </div>
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">3,311</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">6,789</span></p>
</div>
