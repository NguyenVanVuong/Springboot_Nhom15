...
<link href="<c:url value="CSS/show_img.css"/>" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="<c:url value="javascript/jquery-1.7.2.min.js.taixuong"/>"></script>
    <script src="<c:url value="javascript/Common.js.taixuong"/>" type="text/javascript"></script>
    <script src="<c:url value="javascript/PagingContent.js.taixuong"/>" type="text/javascript"></script>
<link rel="shortcut icon" type="image/png" href="<c:url value="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png"/>"></link>
<link href="<c:url value="CSS/lightbox.css"/>" rel="stylesheet" type="text/css">
    <script src="<c:url value="javascript/lightbox.min.js.taixuong"/>" type="text/javascript"></script>
...
<link href="<c:url value="CSS/WebResource.axd"/>" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
<link href="<c:url value="CSS/WebResource(1).axd"/>" type="text/css" rel="stylesheet" class="Telerik_stylesheet">
<link href="<c:url value="CSS/WebResource(2).axd"/>" type="text/css" rel="stylesheet" class="Telerik_stylesheet"></head>
...
<script src="<c:url value="CSS/WebResource(3).axd"/>" type="text/javascript"></script>


<script src="<c:url value="CSS/Telerik.Web.UI.WebResource.axd"/>" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<script src="<c:url value="javascript/jsdebug"/>" type="text/javascript"></script>
<script src="<c:url value="javascript/jsdebug(1)"/>" type="text/javascript"></script>
<script src="<c:url value="javascript/jsdebug(2)"/>" type="text/javascript"></script>
<script src="<c:url value="javascript/jsdebug(3)"/>" type="text/javascript"></script>
<div>
...
<div class="anh_logo"><img alt="" src="<c:url value="img/Banner Hoi nghi quoc te sua.jpg"/>" style="width: 800px; height: 188px;"><br>
</div>
<div class="name_ute">
</div>
</div>
...
<script src="<c:url value="javascript/jquery.nivo.slider.js.taixuong"/>"></script>
...
<div class="container" style="height:350px;">
    <div class="slider-wrapper theme-default">
        ...
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="<c:url value="img/HNQT3.jpg"/>" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: block;">
                <img src="<c:url value="img/HNQT2.jpg"/>" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="<c:url value="img/HNQT1.jpg"/>" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <img class="nivo-main-image" src="<c:url value="img/HNQT2.jpg"/>" style="display: inline; height: auto; width: 1000px;"><div class="nivo-caption"></div><div class="nivo-directionNav"><a class="nivo-prevNav">Prev</a><a class="nivo-nextNav">Next</a></div></div><div class="nivo-controlNav"><a class="nivo-control" rel="0">1</a><a class="nivo-control active" rel="1">2</a><a class="nivo-control" rel="2">3</a></div>
    </div>
</div>
<script>
...
<link href="<c:url value="css/Menu.Green.css"/>" rel="stylesheet" type="text/css">
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        ...
        <a class="wobble-horizontal" href="http://icsse2017.hcmute.edu.vn/?TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2">
            <img src="<c:url value="img/arrow_all_phong.png"/>"></a>
    </div>
